# Code from https://github.com/dannyzed/julian
...
if __name__ == '__main__':
    ...
    mjd = 54372.78
    dt = from_jd(mjd, fmt='mjd')
    print(dt)

    jd = to_jd(dt + timedelta(hours=12), fmt='jd')
    print(jd)   
    
    jd1 = to_jd(datetime(1999, 1, 1) + timedelta(hours=0), fmt='jd')
    jd2 = to_jd(datetime(1999, 1, 1) + timedelta(hours=24), fmt='jd')
    jd3 = to_jd(datetime(1999, 12, 31) + timedelta(hours=24), fmt='jd')
    print(f'One day expected between 19990101 00:00 and 19990101 24:00: {jd2 - jd1}')
    print(f'One year day expected between 19990101 00:00 and 19991231 24:00: {jd3 - jd1}')
